	...
	<div class="container">
		...
		<form name="myform" method="post">
			<div class="input-group">
				...
				<input type="button" value="숫자전송1" onclick="pwdCheck(1)" class="btn btn-success me-2">
				<input type="button" value="숫자전송2" onclick="pwdCheck(2)" class="btn btn-primary me-2">
			</div>
