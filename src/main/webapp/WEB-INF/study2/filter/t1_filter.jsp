...
<body>
	...
	<div class="container">
		...
		<form name="myform" method="post" action="">
			<div>
				<input type="text" name="content" value="간단한 자기 소개란 입니다." class="form-control" autofocus="autofocus" required="required">
			</div>
			<div>
				<textarea rows="5" name="introduce" class="form-control">자기소개서 입니다.</textarea>
			</div>
