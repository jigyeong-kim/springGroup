...
<body>
	...
	<div class="container">
		...
		<form name="myform" action="<%=request.getContextPath()%>/j0805/Test10" method="post">
			...
			<p><input type="button" onclick="fCheck()" value="계산하기" class="btn btn-success form-control"></p>
		</form>
